                ...
                <div class="title grey">
                    <table>
                        <tr>
                            ...
                            <td><h2>US cylinder hero images show uncommon floor tool</h2></td>
                        </tr>
                    </table>
                </div> 
                <hr />
                <div class="body">
                    <p>The images used in the US Digital Leap product selector show a muscle head tool attached:</p>
                    <img src="http://via.placeholder.com/350x250&text=Placeholder" alt="test image">
                    <p>This tool was not commonly included in the US and so isn't ideal as a hero image for each range. Please can these be switched out for hero images that use the turbine tool?</p>
                </div>
